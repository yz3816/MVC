...
@WebServlet("/board/content/humorlist")
public class HumorListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/board/content/HumorList.jsp").forward(req, resp);
	}
